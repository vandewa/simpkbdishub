<div class="page-content">
	...
	if(isset($dt_surat)){
		...
		?>
	<form class="form-horizontal" role="form" action="<?php echo site_url('surat/proses_editmutasi?kd='.$row->kode_uji.'&nouji='.$row->no_uji.'&iduser='.$row->id_user)?>" method="post">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-6">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" id="kota_dinas" name="kota_dinas" placeholder="Tujuan Mutasi" value="<?php echo $row->tujuan_num;?>" class="col-xs-12" />
					</div>
				</div>
			...
			<div class="col-xs-12 col-sm-6">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<select id="kota_dasar" name="kota_dasar" class="select2 col-xs-12" data-placeholder="Pilih Kota yang mengeluarkan STNK/Fiskal...">
							<option></option>
