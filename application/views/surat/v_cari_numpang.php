					...
					<tr>
						...
						<td class="center">
							<div class="hidden-sm hidden-xs btn-group">
								<a href="<?php echo site_url('surat/edit_numpang/'.$this->encryption->encode($row->id_surat));?>" class="tooltip-info" data-rel="tooltip" title="Edit">
								...
								<a href="<?php echo site_url('surat/cetak_numpang/'.$this->encryption->encode($row->id_surat));?>" class="tooltip-warning" data-rel="tooltip" title="Cetak">
									<button class="btn btn-xs btn-warning">
										<i class="ace-icon fa fa-print bigger-120"></i>
									</button>
								</a>
								
								<a href="<?php echo site_url('surat/hapus_numpang/'.$this->encryption->encode($row->id_surat));?>" onclick="return confirm('Anda yakin Menghapus Data Surat?')" class="tooltip-warning" data-rel="tooltip" title="Hapus">
