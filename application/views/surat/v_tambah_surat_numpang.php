...
if(isset($dt_surat)){
	...
	?>
	<form class="form-horizontal" role="form" action="<?php echo site_url('surat/prosesnumpang?kd='.$row->kode_uji.'&nouji='.$row->no_uji.'&iduser='.$row->id_user)?>" method="post">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-6">
				...
				<div class="form-group">
					<label class="col-sm-4 control-label no-padding-left"> Kota </label>
					<div class="col-sm-8">
						<input type="text" id="kota_tujuan" name="kota_tujuan" placeholder="Kota Tujuan" value="<?php echo $row->kota_num;?>" class="col-xs-12" />
					</div>
				</div>	
			</div>
		</div>
