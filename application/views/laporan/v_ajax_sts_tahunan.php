<div class="row">
	<div class="col-xs-12 col-sm-8">
		<h4>
			Laporan Setoran Tahun <?php echo date("Y", strtotime($tgl_akhir));?>
		</h4>
	</div>
	
	<div class="col-xs-12 col-sm-4" align="right">
		<a href="<?php echo site_url('laporan/cetakststahunan?jns=retribusi&awal='.$tgl_awal.'&akhir='.$tgl_akhir);?>">
		...
		<a href="<?php echo site_url('laporan/cetakststahunan?jns=denda&awal='.$tgl_awal.'&akhir='.$tgl_akhir);?>">
