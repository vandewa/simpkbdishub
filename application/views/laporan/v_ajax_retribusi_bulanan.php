<div class="row">
	<div class="col-xs-12 col-sm-10">
		<h4>
			REKAP RETRIBUSI BULANAN <?php echo date("F Y", strtotime($tgl_awal));?> - <?php echo date("F Y", strtotime($tgl_akhir));?>
		</h4>
	</div>
	
	<div class="col-xs-12 col-sm-2" align="right">
		<a href="<?php echo site_url('laporan/exportretribusibulanan?awal='.$tgl_awal.'&akhir='.$tgl_akhir);?>">
