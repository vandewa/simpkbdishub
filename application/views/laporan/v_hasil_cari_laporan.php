<div class="page-content">
		...
		<div class="col-xs-6 col-sm-6">
			<form action="<?php echo site_url('laporan/caridata')?>" method="post">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control search-query" id="cari" value="<?php echo set_value('cari');?>" name="cari"/>
	...
	<div class="row">
		<div class="col-xs-6 col-sm-6">
			<label>Pencarian berdasarkan : <strong><?php if($kategori=='jenis_uji'){?> Jenis Uji 
													<?php } elseif($kategori=='no_uji'){?> Nomor Pengujian
													<?php } elseif($kategori=='jenis'){?>Jenis Kendaraan
													<?php } elseif($kategori=='status'){?>Status Kendaraan
													<?php } else { echo $kategori; }?></strong></label>
		</div>
		<div class="col-xs-6 col-sm-6" align="right">
			<label>Jumlah data ditemukan : <?php echo $jumlah_data; ?></label>
		</div>
	</div>
	<div class="space space-4"></div>
