...
<center>
	<table class="sample" style="font-size:14px;">
    	<tr>
			...
			<td align="center" width="40%">
				...
				BERDASARKAN DAYA ANGKUT, JENIS KENDARAAN, DAN SIFAT<br/>
	...
	<table class="sample" border="1px solid">
    	<thead>
        	<tr>
				<td rowspan="3">NO</td>
				<td rowspan="3">DAYA ANGKUT<br/>(KG)</td>
		...
		<?php 
			$da1 = array("0","1001","2001","3001","4001","5001","6001","7001","8001","9001","10001","12001","14001","16001","18001");
			$da2 = array("1000","2000","3000","4000","5000","6000","7000","8000","9000","10000","12000","14000","16000","18000","100000");
			...
			for($a=0;$a<15; $a++) {
				for($b=0;$b<15; $b++) {
					...
					<tr>
						...
						<td align="center"><?php echo $da1[$a].' - '.$da2[$b]?></td>
						<?php
						for ($i=0;$i<6; $i++) {
							for ($j=0;$j<3; $j++) {
								$jml = $this->laporan->getKendTkc3($tglawal,$tglakhir,$da1[$a],$da2[$b],$jns[$i],$sft[$j]);
								echo "<td align='center'>".$jml."</td>";
							}
						}
						
						for ($j=0;$j<3; $j++) {
							$jml_total = $this->laporan->getJmlKendTkc3($tglawal,$tglakhir,$da1[$a],$da2[$b],$sft[$j]);
							echo "<td align='center'>".$jml_total."</td>";
						}
						
						$jml_semua = $this->laporan->getJmlTotalKendTkc3($tglawal,$tglakhir,$da1[$a],$da2[$b]);
		...
		<thead>
        	<tr>
				...
				for ($i=0;$i<6; $i++) {
					for ($j=0;$j<3; $j++) {
						$jml = $this->laporan->getRangeKendTkc3($tglawal,$tglakhir,$jns[$i],$sft[$j]);
						echo "<td align='center'>".$jml."</td>";
					}
				}
				
				for ($j=0;$j<3; $j++) {
					$jml_total = $this->laporan->getRangeJmlKendTkc3($tglawal,$tglakhir,$sft[$j]);
					echo "<td align='center'>".$jml_total."</td>";
				}
				
				$jml_semua = $this->laporan->getRangeJmlTotalKendTkc3($tglawal,$tglakhir);
				echo "<td align='center'>".$jml_semua."</td>";
				?>
			</tr>
		</thead>
