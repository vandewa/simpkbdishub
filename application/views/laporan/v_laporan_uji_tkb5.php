<div class="page-content">
	<div class="row">
		<div class="col-xs-12 col-sm-12">
			<div class="page-header">
				<h1>
					Laporan Jumlah Kendaraan Uji Berdasarkan Jenis dan Sifatnya
				</h1>
			</div>
		</div>
	</div>
	...
	<div class="row justify-content-center">
		<div class="col-lg-12 widget-container-col" id="widget-container-col-1">
			<div class="widget-box" id="widget-box-1">
				...
				<div class="widget-body">
					<div class="widget-main text-center">
						<form class="form-inline" action="<?php echo site_url('laporan/rekap_ujitkb5')?>" method="get" target="_blank">
