								...
								<div class="widget-main">
									...
									<div class="row">
										<div class="col-xs-12 col-sm-12">
											...
											<label class="block clearfix">
												<div class="form-group">
													<label class="col-sm-4 control-label no-padding-left"> Hasil Uji </label>
													<div class="col-sm-8">
														<input type="text" value="<?php echo $row->hasil;?>" class="col-xs-12" readonly />
													</div>
												</div>
											</label>
											...
											<label class="block clearfix">
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" value="<?php echo strftime("%d %B %Y",strtotime($row->tgl_uji));?> - <?php echo strftime("%d %B %Y",strtotime($row->tgl_habis_uji));?>" class="col-xs-12" readonly />
													</div>
												</div>
											</label>
											...
											<label class="block clearfix">
												<div class="form-group">
													...
													<div class="col-sm-8">
														<input type="text" value="<?php echo $row->nama;?>" class="col-xs-12" readonly />
													</div>
												</div>
											</label>
										</div>
										...
										<div class="alert alert-danger">
											<center>
												<p>Data hasil uji kendaraan tidak ditemukan. Silahkan hubungi UPT PKB Dinas Perhubungan Kabupaten Wonosobo</p>
											</center>
										</div>
