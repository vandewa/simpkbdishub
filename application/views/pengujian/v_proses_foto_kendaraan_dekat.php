		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-6 col-lg-3">
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main center">
							<img class="img-responsive" name="cam2" id="cam2" src="http://admin:PKBSL@WI123@10.10.11.15/Streaming/Channels/1/preview">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-xs-12 col-sm-6 col-lg-3">
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main center">
							<img class="img-responsive" name="cam4" id="cam4" src="http://admin:PKBSL@WI123@10.10.11.11/Streaming/Channels/1/preview">
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	jQuery(function($) {		
		$("#ambil_foto").click(function(){
			$("#dt_foto").load('<?php echo base_url('uji/get_foto_uji_dekat?kode='.$kode_uji.'&no='.$no_uji);?>');
		});
	});
</script>	