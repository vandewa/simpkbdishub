		...
		<div class="row">
				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main center">
							<img class="img-responsive" name="cam1" id="cam1" src="http://admin:hik12345@192.168.1.202/Streaming/Channels/1/preview">
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-sm-6 col-lg-3">
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main center">
							<img class="img-responsive" name="cam2" id="cam2" src="http://admin:hik12345@192.168.1.203/Streaming/Channels/1/preview">
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-sm-6 col-lg-3">
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main center">
							<img class="img-responsive" name="cam3" id="cam3" src="http://admin:hik12345@192.168.1.204/Streaming/Channels/1/preview">
						</div>
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-sm-6 col-lg-3">
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main center">
							<img class="img-responsive" name="cam4" id="cam4" src="http://admin:hik12345@192.168.1.205/Streaming/Channels/1/preview">
						</div>
					</div>
				</div>
			</div>
