<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-6">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" class="col-xs-12" value="<?php echo $row->jenis_kendaraan;?> / <?php echo $row->bentuk;?>"  readonly />
					</div>
				</div>
			</div>
	...
	<form class="form-horizontal" role="form" action="<?php echo site_url('uji/proses_uji_item?kode='.$kode_uji.'&no='.$no_uji.'&uji='.$jenis_uji.'&sts='.$status);?>" method="post">
		...
		<?php $no = 1;
		if(!empty($dt_foto)){ ?>
		<h3 class="header smaller lighter blue">FOTO UJI TERAKHIR</h3>
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group" id="alur">
					...
					<div class="col-xs-7">
						<div class="input-group">
							<input type="tel" id="alur_ban" name="alur_ban" placeholder="Alur ban" class="col-xs-12" value="<?php echo $row->alur_ban;?>" required />
							<span class="input-group-addon">mm</span>
						</div>
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group" id="tint">
					...
					<div class="col-xs-7">
						<div class="input-group">
							<input type="tel" id="tint_meter" name="tint_meter" placeholder="Tembus kaca" class="col-xs-12" value="<?php echo $row->tint_meter;?>" required />
							<span class="input-group-addon">%</span>
						</div>
			...
			<div class="col-sm-6">
				<div class="form-group" id="sound">
					...
					<div class="col-xs-7">
						<div class="input-group">
							<input type="tel" id="sound_level" name="sound_level" placeholder="Kebisingan suara" class="col-xs-12" value="<?php echo $row->sound_level;?>" required />
		...
		<h3 class="header smaller lighter blue">KECEPATAN & KINCUP RODA</h3>
		...
		<div class="row">
			<div class="col-lg-6">
				<div class="form-group" id="kec">
					...
					<div class="col-xs-7">
						<div class="input-group">
							<input type="tel" id="kecepatan" name="kecepatan" placeholder="Kecepatan Kendaraan" class="col-xs-12" value="<?php echo $row->speedometer;?>" required />
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group" id="daya_kiri">
					...
					<div class="col-xs-7">
						<div class="input-group">
							<input type="tel" id="lampu_kiri" name="lampu_kiri" placeholder="Lampu Kiri" class="col-xs-12" value="<?php echo $row->lampu_kiri;?>" required />
				...
				<div class="form-group" id="derajat_kiri">
					...
					<div class="col-xs-7">
						<div class="input-group">
							<input type="tel" id="derajat_lampu_kiri" name="derajat_lampu_kiri" placeholder="Derajat Kiri" class="col-xs-12" value="<?php echo $row->derajat_lampu_kiri;?>" required />
			...
			<div class="col-sm-6">
				<div class="form-group" id="daya_kanan">
					...
					<div class="col-xs-7">
						<div class="input-group">
							<input type="tel" id="lampu_kanan" name="lampu_kanan" placeholder="Lampu Kanan" class="col-xs-12" value="<?php echo $row->lampu_kanan;?>" required />
							<span class="input-group-addon">cd</span>
						</div>
						<span class="help-block">Min : 12.000 cd</span>
					</div>
				...
				<div class="form-group" id="derajat_kanan">
					...
					<div class="col-xs-7">
						<div class="input-group">
							<input type="tel" id="derajat_lampu_kanan" name="derajat_lampu_kanan" placeholder="Derajat Kanan" class="col-xs-12" value="<?php echo $row->derajat_lampu_kanan;?>" required />
							<span class="input-group-addon">&deg;</span>
						</div>
		...
		<div class="alert alert-danger text-center">
			<strong>Perhatian!!!</strong> Harap isi berat kendaraan terlebih dahulu untuk mengisi hasil uji pengereman.
		</div>
		<?php } ?>
		...
		<div class="row">
			<div class="col-lg-9">
				...
				<div class="form-group" id="br_ps1">
					...
					<div class="col-sm-2">
						<input type="tel" id="brake_kiri_s1" name="brake_kiri_s1" placeholder="Rem Sumbu1 Kiri" class="col-xs-12" value="<?php echo $row->br_kiri_s1;?>" required />
					</div>
					
					<label class="col-sm-2 control-label no-padding-left text-right"> S1 KANAN </label>
					<div class="col-sm-2">
						<input type="tel" id="brake_kanan_s1" name="brake_kanan_s1" placeholder="Rem Sumbu1 Kanan" class="col-xs-12" value="<?php echo $row->br_kanan_s1;?>" required />
					</div>
				...
				<div class="form-group" id="br_ps2">
					...
					<div class="col-sm-2">
						<input type="tel" id="brake_kiri_s2" name="brake_kiri_s2" placeholder="Rem Sumbu2 Kiri" class="col-xs-12" value="<?php echo $row->br_kiri_s2;?>" required />
					</div>
					
					<label class="col-sm-2 control-label no-padding-left text-right"> S2 KANAN </label>
					<div class="col-sm-2">
						<input type="tel" id="brake_kanan_s2" name="brake_kanan_s2" placeholder="Rem Sumbu2 Kanan" class="col-xs-12" value="<?php echo $row->br_kanan_s2;?>" required />
					</div>
		...
		<div class="row">
			<div class="col-lg-9">
				<div class="form-group" id="parkir">
					...
					<div class="col-sm-2">
						<input type="tel" id="brake_kiri_parkir" name="brake_kiri_parkir" placeholder="Rem Parkir Kiri" class="col-xs-12" value="<?php echo $row->br_tangan_kiri;?>" required />
					</div>
					
					<label class="col-sm-2 control-label no-padding-left text-right"> PARKIR KANAN </label>
					<div class="col-sm-2">
						<input type="tel" id="brake_kanan_parkir" name="brake_kanan_parkir" placeholder="Rem Parkir Kanan" class="col-xs-12" value="<?php echo $row->br_tangan_kanan?>" required />
					</div>
		...
		<?php if(($jenis_uji=="kecepatan") && ($row->bk_sumbu1=="0")) { ?>
		<div class="alert alert-danger text-center">
			<strong>PERHATIAN!!!</strong> HASIL UJI TIDAK BISA DIPROSES, SILAHKAN ISI BERAT KENDARAAN DAN PENGEREMAN TERLEBIH DAHULU
		</div>
		<?php } else { ?>
...
<script type="text/javascript">
	jQuery(function($) {
		$('.add_catatan').click(function(e) {
			e.preventDefault();
				$('#formcatatan').append('<div class="form-group"><label class="col-xs-2 control-label no-padding-left"> Catatan </label><div class="col-xs-9"><select class="select2 col-xs-12" id="catatan" name="catatan[]" data-placeholder="Pilih catatan kerusakan"><option></option><?php foreach($dt_kerusakan as $rsk){ ?><option value="<?php echo $rsk->kerusakan;?>"><?php echo $rsk->kerusakan;?></option><?php } ?></select></div><div class="col-xs-1"><a href="#" class="hapus_catatan btn btn-danger btn-sm" title="Hapus catatan"><i class="ace-icon fa fa-times icon-only"></i></a></div></div>');
			});
		...
		$('input').keyup(function(e){
			...
			if(rem_utama>100){
				alert("Efisiensi Rem Utama tidak boleh melebihi 100%, Harap cek kembali hasil uji pengereman utama.")
			}
			
			if(rem_parkir>100){
				alert("Efisiensi Rem Parkir tidak boleh melebihi 100%, Harap cek kembali hasil uji pengereman parkir.")
			}
