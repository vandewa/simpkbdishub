...
for($i = 0; $i < 4; $i++){
	...
	$url0 = 'http://192.168.1.24/Streaming/Channels/1/picture?videoResolutionWidth=1280';
	$url1 = 'http://192.168.1.25/Streaming/Channels/1/picture?videoResolutionWidth=1280';
	$url2 = 'http://192.168.1.23/Streaming/Channels/1/picture?videoResolutionWidth=1280';
	$url3 = 'http://192.168.1.21/Streaming/Channels/1/picture?videoResolutionWidth=1280';

	$username='admin';
	$password='PKBSL@WI123';
