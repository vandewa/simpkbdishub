<div class="page-content">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-4" align="center">
			<a href="<?php echo site_url('uji/belumujiskrg');?>" class="tooltip-success" data-rel="tooltip" title="Tampil Semua Kendaraan">
		...
		<div class="col-xs-12 col-sm-4">
		<form action="<?php echo site_url('uji/rekapbelumuji')?>" method="post">
			<div class="input-group">
				<span class="input-group-addon">
