	...
	<div class="row">
		<div class="col-xs-12">
			<table id="simple-table" class="table table-striped table-bordered table-hover">
				...
				<tbody>
				<?php $no=1; foreach($dt_uji as $row){ ?>
					<tr>
						...
						<td>
							<div class="hidden-sm hidden-xs btn-group">
								<a href="<?php echo site_url('uji/proses_ujivisual?id='.$row->kode_uji.'&uji='.$this->router->fetch_method().'&sts='.$status);?>" class="tooltip-success" data-rel="tooltip" title="Input Pengujian">
