<div class="page-content">
	<div class="page-header">
		<h1>
			Data Pengujian Sudah Perso
		</h1>
	</div>
	
	<div class="row">
		<div class="col-xs-12 col-sm-4">
		<form action="<?php echo site_url('uji/caridata')?>" method="post">
			...
			<table id="simple-table" class="table table-striped table-bordered table-hover">
				...
				if(isset($data_pengujian)){
					...
					<tr>
						...
						<td>
							<a href="<?php echo site_url('uji/lihatperso?id='.$row->idx.'&nouji='.$row->nouji);?>" class="tooltip-info" data-rel="tooltip" title="Lihat">
								<button class="btn btn-xs btn-success">
									<i class="ace-icon fa fa-search bigger-120"></i>
								</button>
							</a>
							
							<a href="<?php echo site_url('uji/editperso?id='.$row->idx.'&nouji='.$row->nouji);?>" onclick="return confirm('Anda yakin akan merubah data perso?')" class="tooltip-warning" data-rel="tooltip" title="Edit Hasil Uji">
								<button class="btn btn-xs btn-warning">
									<i class="ace-icon fa fa-pencil bigger-120"></i>
								</button>
							</a>
							
							<a href="<?php echo site_url('uji/hapusperso?id='.$row->idx.'&nouji='.$row->nouji);?>" onclick="return confirm('Anda yakin menghapus data perso?')" class="tooltip-warning" data-rel="tooltip" title="Hapus Perso">
