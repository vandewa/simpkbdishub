...
for($i = 0; $i < 4; $i++){
	...
	$url1 = 'http://192.168.1.26/Streaming/Channels/1/picture?videoResolutionWidth=1280';
	$url2 = 'http://192.168.1.23/Streaming/Channels/1/picture?videoResolutionWidth=1280';
	$url3 = 'http://192.168.1.20/Streaming/Channels/1/picture?videoResolutionWidth=1280';
