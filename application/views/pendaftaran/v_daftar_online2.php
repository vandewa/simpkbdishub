										...
										<div>
											<ul class="steps">
												<li data-step="1" class="active">
													...
													<span class="title">Petunjuk Pendaftaran</span>
												</li>
										...
										<div class="step-content pos-rel">
											<div class="step-pane active" data-step="1">
												...
												<ol>
													...
													<li>Jika kendaraan belum pernah terdaftar di Unit Pelayanan Pengujian Kabupaten Jepara, maka pemohon harus mengisi semua formulir yang disediakan.</li>
											...
											<div class="step-pane" data-step="3">
													<div class="form-group">
														...
														<div class="col-sm-9">
															<select class="select2" id="metode_pembayaran" name="metode_pembayaran" data-placeholder="Pilih metode pembayaran" required >
																<option></option>
																<option value="Berkala">Uji Berkala</option>
															</select>
														</div>
