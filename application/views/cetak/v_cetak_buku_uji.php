	...
	*/
	...
	function Dinas($detail_dinas){
		foreach($detail_dinas as $row){
			...
			$this->cell(130,0);
			$this->cell(40,0,'KAB. MADIUN',0,0,'L');
			$this->Ln(11);
			$this->cell(130,0);
			...
			$this->Ln(4);
			$this->cell(125,0);
			$this->cell(40,0,'KAB. MADIUN',0,0,'C');
	...
	function Depan($detail_buku){
		foreach($detail_buku as $row){
			...
			//$this->Image(base_url().'files/barcode/'.$row->barcode,110,80,0,12,'PNG');
	...
	function Buku($detail_buku){
		foreach($detail_buku as $row){
			...
			//$this->Image(base_url().'files/qrcode/'.$row->qrcode,10,75,25,0,'PNG');
	...
	function Detail($detail_buku){
		foreach($detail_buku as $row){
			...
			$this->Ln(2);
			$this->Cell(55,0);
			$this->Cell(20,0,$row->uk_roh,0,0,'L');
			$this->Cell(50,0);
			$this->Cell(20,0,$row->bk_sumbu3,0,0,'L');
			$this->Ln(2);
			$this->Cell(45,0);
			$this->Cell(20,0,$row->uk_foh,0,0,'L');
			$this->Cell(70,0);
			...
			$this->Ln(3);
			$this->Cell(125,0);
			$this->Cell(25,0,$row->kelas_jalan,0,0,'L');
			$this->Ln(3);
			$this->Cell(45,0);
	...
	function hasil_uji($detail_buku){
		foreach($detail_buku as $row){
			...
			$this->Cell(23,0,"NRP. ".$row->no_reg,0,0,'C');
