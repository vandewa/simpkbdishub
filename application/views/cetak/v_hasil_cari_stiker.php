<div class="page-content">
	<div class="page-header">
		<h1>
			Cetak Stiker dan Buku
		</h1>
	</div>
	
	<div class="row">
		<div class="col-xs-6 col-sm-4">
			<form action="<?php echo site_url('cetak/cr_stiker')?>" method="post">
	...
	<div class="row">
		<div class="col-xs-12">
			<table id="simple-table" class="table table-striped table-bordered table-hover">
				...
				<?php
				$no=1;
				if(isset($cari_stiker)){
					foreach($cari_stiker as $row){
					?>
				<tbody>
					<tr>
						...
						<td class="center">
							<div class="hidden-sm hidden-xs btn-group">
								...
								<a href="<?php echo site_url('uji/cetak_stiker/'.$this->encryption->encode($row->kode_uji));?>" class="tooltip-warning" data-rel="tooltip" title="Cetak stiker barang">
									<button class="btn btn-xs btn-warning">
										<i class="ace-icon fa fa-truck bigger-120"></i>
									</button>
								</a>
								
								<a href="<?php echo site_url('uji/cetak_stiker_bus/'.$this->encryption->encode($row->kode_uji));?>" class="tooltip-warning" data-rel="tooltip" title="Cetak stiker bus">
									<button class="btn btn-xs btn-warning">
										<i class="ace-icon fa fa-bus bigger-120"></i>
									</button>
								</a>
								
								<a href="<?php echo site_url('uji/cetak_buku/'.$this->encryption->encode($row->kode_uji));?>" class="tooltip-warning" data-rel="tooltip" title="Cetak Buku Halaman 1">
									<button class="btn btn-xs btn-warning">
										<i class="ace-icon fa fa-book bigger-120"></i>
									</button>
								</a>
								
								<a href="<?php echo site_url('uji/cetak_buku_detail/'.$this->encryption->encode($row->kode_uji));?>" class="tooltip-warning" data-rel="tooltip" title="Cetak Buku Halaman 2">
									<button class="btn btn-xs btn-warning">
										<i class="ace-icon fa fa-book bigger-120"></i>
									</button>
								</a>
