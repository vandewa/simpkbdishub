...
{	
	function Content($detail_kendaraan){
		foreach($detail_kendaraan as $row){
			...
			$this->ln();
			$this->cell(20,0);
			$this->cell(225,8,'DINAS PERUMAHAN KAWASAN PERMUKIMAN DAN PERHUBUNGAN',0,0,'L');
			$this->cell(75,8,'',1,0,'C');
			$this->ln(14);
			$this->Image(base_url().'assets/images/logo_kab_wonosobo.png',5,5,15,0,'PNG');
			...
			*/
			...
			$this->cell(100,5,': ','R',0,'L');
			$this->cell(50,5,'TINGGI','',0,'L');
			$this->cell(60,5,': ','R',0,'L');
	...
	function Content2($detail_kendaraan){
		foreach($detail_kendaraan as $row){
			...
			$this->ln();
			$this->cell(20,0);
			$this->cell(220,8,'DINAS PERUMAHAN KAWASAN PERMUKIMAN DAN PERHUBUNGAN',0,0,'L');
			$this->cell(80,8,'',1,0,'C');
			$this->ln();
			$this->cell(240,0);
			...
			$this->cell(40,10,'','RL',0,'C');
			$this->cell(80,10,'','RL',0,'L');
			$this->cell(120,10,'','RL',0,'L');
