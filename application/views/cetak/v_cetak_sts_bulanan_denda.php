...
class PDF extends FPDF
{
	...
	function terbilang($terbilang){
		...
		$this->cell(100,5,': Pendapatan Denda Retribusi Jasa Umum',0,0,'L');
		$this->ln(7);
		...
		$this->cell(50,6,'4. 1. 4. 08. 01.',1,0,'C');
		$this->cell(90,6,'Pendapatan Denda Retribusi Jasa Umum',1,0,'C');
	...
	function sts($dt_sts){
		foreach($dt_sts as $row){
			...
			$this->cell(90,6,'Tanggal '.date("d F Y",strtotime($row->tgl_pembayaran)),1,0,'C');
			$this->cell(40,6,$jml_denda,1,0,'R');
		}
	}
