	...
	<form class="form-horizontal" role="form" action="<?php echo site_url('retribusi/tambahretribusi')?>" method="post">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-2" align="right">
				<input type="text" id="tgl_retribusi" name="tgl_retribusi" value="" class="col-xs-12" readonly />
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-6">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" id="no_retribusi" name="no_retribusi" value="" class="col-xs-12" readonly />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" id="no_kendaraan_retribusi" name="no_kendaraan" value="" class="col-xs-12" readonly />
					</div>
				</div>
			</div>
			...
			<div class="col-xs-12 col-sm-6">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" id="retribusi_no_uji" name="no_uji" value="" class="col-xs-12" readonly />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" id="retribusi_nama" name="nama" value="" class="col-xs-12" readonly />
					</div>
				</div>	
			</div>
		</div>
...
<div id="tambah-retribusi" class="modal fade" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form class="form-horizontal" role="form" method="post" action="<?php echo site_url('retribusi/tambah_retribusi_to_cart')?>">
				<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
