		...
		<div class="row">
			<div class="col-xs-12 col-sm-6">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" id="no_kendaraan_retribusi" name="no_kendaraan" class="autocomplete no_kendaraan col-xs-12" readonly />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" id="retribusi_no_uji" name="no_uji" value="" class="autocomplete col-xs-12" readonly />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" id="retribusi_nama" name="nama" value="" class="autocomplete col-xs-12" readonly />
					</div>
				</div>	
			...
			<div class="col-xs-12 col-sm-6">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<select class="chosen-select form-control" id="retribusi_jenis" name="retribusi_jenis" data-placeholder="Pilih jenis retribusi">
							<option value=""></option>
							<?php
							if(isset($data_tarif)){
