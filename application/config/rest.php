...
|
*/
$config['rest_realm'] = 'REST API AUTH';
...
$config['auth_override_class_method']['api']['kendaraan'] = 'none';
$config['auth_override_class_method']['api']['retribusi'] = 'none';
$config['auth_override_class_method']['api']['pembayaran'] = 'none';
$config['auth_override_class_method']['api']['transaksi'] = 'none';
// $config['auth_override_class_method']['deals']['insert'] = 'digest';
// $config['auth_override_class_method']['accounts']['user'] = 'basic';
...
|
*/
$config['rest_valid_logins'] = ['Ek1RD1sSl@w1' => 'h2H3k1rD15hU8sL@wi'];
